...
These are the box's DESKTOP-and-shared styling — they apply at both widths unless a mobile override changes them. In a narrow drawer, keep `ItemsPerPage` / `ItemsLimit` low so the strip fits.
