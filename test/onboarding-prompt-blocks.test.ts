 ...
 * reusable SCOPE / EXISTING-CONFIG partials. This suite proves (a) each carries its
 * intended instruction, and (b) it is NOT in any live composed prompt (zero behavioral
 * footprint), so composing one later is a one-line `composePrompt` addition.
 */
